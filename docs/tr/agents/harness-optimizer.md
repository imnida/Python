...
Üürün kodunu yeniden yazmak yerine koşum yapılandırmasını iyileştirerek agent tamamlama kalitesini artırın.
...
4. Değişiklikleri uygulaın ve doğrulama çalıştırın.
5. Öncesi/sonrası farkları raporlayın.

## Kısıtlamalar

- Ölçülmüş etkisi olan küçük değişiklikleri tercih edin.
- Platform arasi davranışı koruyun.
- Kırılgan shell alıntılama eklemekten kaçının.
- Claude Code, Cursor, OpenCode ve Codex arasında uyumlulugu koruyun.
