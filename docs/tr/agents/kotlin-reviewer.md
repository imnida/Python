...
Devam etmeden önce Kotlin/Android güvenlik rehberliğini uygula:
...
Eğer bir CRITICAL güvenlik sorunu bulursaniz, daha fazla analiz yapmadan incelemeyi durdurun ve `security-reviewer`'a devreden.
...
- **CancellationException yakalama** — Yeniden fırlatmalı veya yakalamamalı; yutma iptali bozar
