...
4. **Güvenli Refactoring** -- Değişikliklerin işlevsellik bozmadığından emin olun
...
- Tüm referanslar için grep yapın (string patternleri üzerindan dinamik import'lar dahil)
...
- En iyi uygulama seçin (en eksiksiz, en iyi test edilmiş)
...
1. **Küçük başlayın** -- her seferede bir kategori
2. **Sık test edin** -- her gruptan sonra
3. **Muhafazakâr olun** -- şüpheye düştüğününde, kaldırmayın
