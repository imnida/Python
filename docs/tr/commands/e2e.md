...
5. **Dengesiz Testleri Tanımla** - Kararssız testleri karantinaya al
...
- Ürütime dağıtım için hazırlanırken
...
4. İlk sonuca tıkla
5. Piyasa detay sayfasının yüklendiginii doğrula
...
test.describe('Market Search and View Flow', () => {
  test('kullanıcı piyasaları arayabilir ve detayları görüntüleyebilir', async ({ page }) => {
    ...
    // 5. Piyasa detay sayfasının yüklendiini doğrula
...
Testler çalıştığında, şu artifact'lar yakalanr:
...
```
WARNING:  DENGEŞİZ TEST TESPT EDİLDİ: tests/e2e/markets/trade.spec.ts
...
- Sadece küçük test fonlarıyla test cüzzdanları kullanın
