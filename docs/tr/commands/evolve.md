---
name: evolve
description: İçgüdüleri analiz et ve evrimlemiş yapılar öner veya oluştur
command: true
---
...
İçgüdüleri analiz eder ve ilgili olanları daha üst seviye yapılara kümeler:
...
### → Agent (Derinlik/İzasyon Gerektirir)
...
4. Şunları tanımla:
   - Skill adayları (2+ içgüdüe sahip tetikleyici kümeleri)
...
- `--generate`: Analiz çıktısına ek olarak evrimlemiş dosyaları oluştur
...
[Külmelemiş içgüdülere dayalı oluşturulan içerik]
