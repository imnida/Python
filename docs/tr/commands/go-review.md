...
3. **Güvenlik Taraşı**: SQL injection, command injection, race condition'ları kontrol et
...
- Context yayılmıyor
- Deadlock'a neden olan buffersz channel'lar
...
- Go'ya özgü olmayan endişeler için `/code-review` kullanın
