...
3. **Adım Planı Oluştur** - Uygulamaı fazlara ayır
...
- Karmaişk refactoring üzerinde çalışırken
...
4. **Riskleri değerlendireceğk** ve potansiyel engelleri belirleyecek
...
- Tamamlanan uygulamaı gözden geçirmek için `/code-review` kullanın
