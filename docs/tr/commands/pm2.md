...
**Port Tespit Öncelii**: Kullanıcı belirtimi > .env > config dosyası > script argümanları > varsayılan port
...
**İpuçu:** Basitleştirilmiş komutları etkinleştirmek için ilk başlatmadan sonra `pm2 save` çalıştırın.
```
