...
### statusline.json
Özel durum satırı konfigürasyon. Claude Code'un terminal arayüzzünde gösterilen durum satırını özelleştirir.

**Özellikler:**
- Kullanıcı adı ve çalışma dizini
- Git branch ve dirty status
- Kalan context yüdesi
- Model adı
- Saat
- Todo sayısı
