...
Kullanıcı seviyesi konfigürasyon global olarak tüm projeler genelinde uygulanır. Şurınlar için kullanın:
...
| agents.md | Agent orkestrasyon, hangi agent'in ne zaman kullanılacağı |
...
### Gizlilik
- Logları her zaman redact et; asla secret'ları yapıştirma (API key'ler/token'lar/şifreler/JWT'ler)
