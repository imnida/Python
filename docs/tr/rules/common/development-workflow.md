...
0. **Araştırma & Yeniden Kullanım** _(her yeni implementasyondan önce zorunlu)_
   ...
   - **İlk ikisi yetersiz olduğunda Exa:** GitHub araması ve birincil dokümanlardan sonra daha geniş web araştırması veya keşfetme için Exa kullan.
   ...
   - **Adapte edilebilir implementasyonlar ara:** Problemin %80+'ını çözen ve fork'lanabilir, port edilebilir veya wrap edilebilir açık kaynak projeler ara.
