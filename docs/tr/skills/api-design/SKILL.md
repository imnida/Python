...
| PUT | Evet | Hayır | Kayanğın tam değişimi |
| PATCH | Hayır* | Hayır | Kayanğın kısmi güncellemesi |
| DELETE | Evet | Hayır | Kayanğı kaldır |
...
// Başarı: kayanğı doğrudan döndür
...
**Eksileri:** Rastgele sayfaya atlanamaz, cursor opak
...
- [ ] Dokümente edilmiş (OpenAPI/Swagger spec güncellenmiş)
